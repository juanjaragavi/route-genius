  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="p-2 rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100/80 active:scale-95 transition-all duration-150"
      >
        <MoreHorizontal className="w-4 h-4" />
      </button>

      {open && (
        <div className="absolute right-0 top-10 z-30 w-48 rounded-xl bg-white border border-gray-200 shadow-xl py-1.5 animate-in fade-in-0 zoom-in-95 duration-150">
          <a
