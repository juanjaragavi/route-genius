  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="p-2.5 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg text-gray-400 hover:text-gray-600 hover:bg-gray-100 transition-colors"
      >
        <MoreHorizontal className="w-4 h-4" />
      </button>

      {open && (
        <div className="absolute right-0 top-11 z-30 w-48 rounded-xl bg-white border border-gray-200 shadow-lg py-1">
          <a
